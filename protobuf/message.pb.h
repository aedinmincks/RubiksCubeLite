...
PROTOBUF_NAMESPACE_OPEN
template<> ::Protobuf::Array* Arena::CreateMaybeMessage<::Protobuf::Array>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace Protobuf {
...
class Array PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Protobuf.Array) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:Protobuf.Array)
 private:
  class _Internal;
...
inline ::PROTOBUF_NAMESPACE_ID::int32 Array::_internal_array(int index) const {
  return array_.Get(index);
}
inline ::PROTOBUF_NAMESPACE_ID::int32 Array::array(int index) const {
  // @@protoc_insertion_point(field_get:Protobuf.Array.array)
  return _internal_array(index);
}
inline void Array::set_array(int index, ::PROTOBUF_NAMESPACE_ID::int32 value) {
  array_.Set(index, value);
  // @@protoc_insertion_point(field_set:Protobuf.Array.array)
}
inline void Array::_internal_add_array(::PROTOBUF_NAMESPACE_ID::int32 value) {
  array_.Add(value);
}
inline void Array::add_array(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_add_array(value);
  // @@protoc_insertion_point(field_add:Protobuf.Array.array)
}
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int32 >&
Array::array() const {
  // @@protoc_insertion_point(field_list:Protobuf.Array.array)
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int32 >*
Array::mutable_array() {
  // @@protoc_insertion_point(field_mutable_list:Protobuf.Array.array)
